...
const adc1_channel_t adc_channel = ADC1_GPIO34_CHANNEL;
...
#if (ESP32_AUDIO_OUT_MODE == INTERNAL_DAC || ESP32_AUDIO_OUT_MODE == INTERNAL_DAC_AND_I2S_ADC )
#define AUDIO_BITS 8
#define PDM_RESOLUTION 1
#elif (ESP32_AUDIO_OUT_MODE == I2S_DAC || ESP32_AUDIO_OUT_MODE == I2S_DAC_AND_INTERNAL_ADC || ESP32_AUDIO_OUT_MODE == I2S_DAC_AND_I2S_ADC)
...
#if (ESP32_AUDIO_OUT_MODE == I2S_DAC_AND_INTERNAL_ADC || ESP32_AUDIO_OUT_MODE == I2S_DAC_AND_I2S_ADC || ESP32_AUDIO_OUT_MODE == INTERNAL_DAC_AND_I2S_ADC)
